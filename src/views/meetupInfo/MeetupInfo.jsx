...
export default function MeetupInfo() {
  ...
  const bookMeetup = async () => {
    ...
    try {
      const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyTmFtZSI6IkhhbWRpIiwidXNlcklkIjoidSMwMzY3ZjAyMi1hMmVjLTQ4OGEtOTJmNS0zZGVjMDI1N2VmOTYiLCJpYXQiOjE2OTgzOTE4NDEsImV4cCI6MTY5ODM5Mzg0MX0.KWmDyLgHGOwVwuTbrQw2Wm6qiSPYye8U5vtXifYGCXc"
  ...
  return (
    <div className="meetup-info">
      ...
      <Button  className="bookingBtn" onClick={bookMeetup}>Get tickets</Button>
